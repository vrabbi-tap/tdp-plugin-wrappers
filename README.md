...
| **Security**              | **Vault**                   | **Frontend**    | [Wrapper Code](./plugins/vault-wrapper)                      | [Source Plugin Repo](https://github.com/backstage/backstage/blob/master/plugins/vault/README.md)                                                      | [Published Package](https://www.npmjs.com/package/@vrabbi/vault-wrapper)                      |
|                           |                             | **Backend**     | [Wrapper Code](./plugins/vault-wrapper-backend)              | [Source Plugin Repo](https://github.com/backstage/backstage/blob/master/plugins/vault-backend/README.md)                                              | [Published Package](https://www.npmjs.com/package/@vrabbi/vault-wrapper-backend)              |
